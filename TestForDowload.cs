...
//            string output = "TenantMapping/TenantAsnMapping_2021-07-31_test.csv";
//            CloudBlockBlob outputBlob = container.GetBlockBlobReference(output);

//            TimeLogger.setLogger(log);
//            TestBlob(inputBlob, outputBlob, log);
//            //try
//            //{
...
//        public static void TestBlob(CloudBlockBlob inputBlob, CloudBlockBlob outputBlob, ILogger log)
//        {
//            using (var memoryStream = new MemoryStream())
//            {
//                TimeLogger.startTimeLogger();
//                inputBlob.DownloadRangeToStreamAsync(memoryStream, 0, 1024).Wait();
//                TimeLogger.stopTimeLogger("download complete");
//                string s = Encoding.ASCII.GetString(memoryStream.ToArray());
//                log.LogInformation("downloaded data:\n" + s);
//                TimeLogger.startTimeLogger();
//                outputBlob.UploadFromStreamAsync(memoryStream).Wait();
//                TimeLogger.stopTimeLogger("upload complete");
//            }
//        }
//    }
//}
